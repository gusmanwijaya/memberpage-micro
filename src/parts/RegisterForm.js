  ...
  return (
    <div className="flex justify-center items-center pb-24">
      <div className="w-full sm:w-3/12">
        <h1 className="text-4xl text-gray-900 mb-6 leading-normal">
        ...
        <form onSubmit={submit}>
          ...
          <Select
            ...
            onClick={setState}
          >
            <option value="">Select yout focus</option>
      ...
      <div className="w-5/12 hidden sm:flex justify-end pt-24 pr-16">
        <div className="relative" style={{ width: 369, height: 440 }}>
          ...
          <div className="absolute w-full h-full -mb-8 -ml-8">
            <img src="assets/images/james.jpg" alt="Hero" />
          </div>
          <div
          ...
          >
            ...
            <span className="text-gray-600">James, Backend Developer</span>
          </div>
        </div>
      </div>
    </div>
